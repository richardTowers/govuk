...
const translations = z.object({
  ...
  homepage: z.object({
    categories: z.array(
      z.object({ title: z.string(), description: z.string(), link: z.string() })
    ),
    ...
    index: z.object({
      ...
      popular_links: z.array(z.object({ text: z.string(), href: z.string() })),
...
export default async function loadTranslations(locale: string) {
  const content = await readFile((function (l) { return "submodules/frontend/config/locales/".concat(l, ".yml"); })(locale))
