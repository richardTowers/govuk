...
const translations = z.object({
  ...
  content_item: z.object({
    ...
    schema_name: z.object({
      ...
      asylum_support_decision: z.object({ one: z.string(), other: z.string() }),
      ...
      service_standard_report: z.object({ one: z.string(), other: z.string() }),
      ...
      statement_to_parliament: z.object({ one: z.string(), other: z.string() }),
      statistical_data_set: z.object({ one: z.string(), other: z.string() }),
      statistics_announcement: z.object({ one: z.string(), other: z.string() }),
  ...
  guide: z.object({ pages_in_guide: z.string(), skip_to_contents: z.string() }),
...
export default async function loadTranslations(locale: string) {
  const content = await readFile((function (l) { return "submodules/government-frontend/config/locales/".concat(l, ".yml"); })(locale))
